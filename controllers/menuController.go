...
func GetMenus() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while liting the menu items"})
		}
		var allMenus []bson.M
...
// to update
// should be done in a time efficent manner
// dates -start and end
// 1. take the object from the mongodb
// 2. validate new input object
// 3. insert new object
